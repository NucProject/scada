...
namespace Scada.Declare
{
    class AmbData
    {
        ...
        public AmbData(Device device)
        {
            this.Magneticfield = string.Empty;
            this.Electricfield = string.Empty;
            this.Temperature = string.Empty;
            this.Humidity = string.Empty;
            RecordManager.DoSystemEventRecord(device, "new AmbData()");
        }

        public bool IsReady()
        {
            return Temperature.Length > 0 && Electricfield.Length > 0;
        }
    ...
    public class Amb8059Device : Device
    {
        ...
        private AmbData currentData = null;

        public Amb8059Device(DeviceEntry entry)
        {
            this.entry = entry;
        ...
        private void StartVirtualDevice()
        {
            ...
            {
                this.OnSendDataToVirtualDevice();
            }
        }
        ...
        private void Write2ActionsToPort()
        {
            this.currentActionSend = this.actionSend1;
        ...
        private void OnSendDataToVirtualDevice()
        {
            if (this.actionInterval > 0)
            {
                this.currentActionSend = this.actionSend1;
        ...
        private bool GetDeviceData(byte[] line, DateTime time, out DeviceData dd)
        {
            ...
            try
            {
                ...
                if (this.currentActionSend == this.actionSend1)
                {
                    ...
                    {
                        this.currentData = new AmbData(this);
