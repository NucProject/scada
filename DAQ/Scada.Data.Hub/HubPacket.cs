...
namespace Scada.Data.Hub
{
    ...
    public class HubPacket : Packet
    {
        ...
        public static HubPacket CreateRealtimePacket(DeviceConfig deviceConfig, DateTime time)
        {
            var p = new HubPacket();
            p.realtime = true;
        ...
        override public bool SetSendStatus(DeviceConfig deviceConfig, DateTime time)
        {
